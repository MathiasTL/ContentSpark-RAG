 ...
 *
 * El logo va inline con los colores oficiales de marca: son los únicos
 * colores del producto que no pasan por los tokens, porque no nos pertenecen
 * y Google exige que no se alteren. Es una excepción de marca de terceros,
 * no un hardcodeo.
 */
