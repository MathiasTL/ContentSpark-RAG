...
export default function ChatMobileDrawerToggle() {
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 items-center justify-center rounded-full border border-glass-edge bg-surface-container-lowest/20 text-on-surface backdrop-blur-2xl transition-colors hover:bg-surface-container-lowest/40 lg:hidden"
    >
