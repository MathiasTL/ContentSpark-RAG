  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden={!isOpen}
        className={`fixed inset-y-0 left-0 z-[70] flex h-dvh w-72 max-w-[85vw] flex-col border-r border-glass-edge-soft bg-surface/90 p-4 backdrop-blur-md transition-transform duration-300 ease-out motion-reduce:duration-0 lg:hidden ${
