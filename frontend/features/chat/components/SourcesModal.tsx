      ...
      >
        <div className="flex items-center justify-between border-b border-glass-edge-soft bg-surface-container-lowest/20 px-6 py-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-xl border border-glass-edge bg-surface-container-lowest/45 px-3 py-1.5 text-xs font-medium text-on-surface transition-colors duration-150 hover:bg-surface-container-lowest/65 cursor-pointer"
          >
            Cerrar
          </button>
        </div>
          ...
          <div className="p-5 space-y-3">
            ...
            {!isLoading && !error &&
              sources.map((source) => (
                <div
                  key={source.id}
                  className="rounded-2xl border border-glass-edge bg-surface-container-lowest/35 px-4 py-3 flex items-center justify-between"
                >
