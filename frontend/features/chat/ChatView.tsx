...
function WelcomeMessage() {
  return (
    <div className="flex flex-col items-center justify-center gap-4 py-6 text-center">
      <div className="flex h-20 w-20 items-center justify-center rounded-3xl border border-glass-edge bg-surface-container-lowest/30 p-3 shadow-lg backdrop-blur-2xl">
...
function TypingIndicator() {
  return (
    <div className="flex max-w-3xl gap-4">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-glass-edge bg-surface-container-lowest/20 p-1.5 shadow-lg backdrop-blur-2xl">
        <Image src="/only_logo.png" alt="AI" width={28} height={28} />
      </div>
      <div className="rounded-3xl rounded-tl-none border border-glass-edge bg-surface-container-lowest/40 px-6 py-4 backdrop-blur-2xl">
      ...
      <section className="relative flex h-dvh min-w-0 flex-1 flex-col overflow-hidden bg-surface/60 backdrop-blur-md">
            ...
            <AnimatePresence initial={false}>
              {messages.map((msg, i) =>
                msg.role === "user" ? (
                  ...
                  >
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-full border border-glass-edge bg-primary-container shadow-lg">
                      <UserCircle2 className="h-7 w-7 text-on-primary" strokeWidth={1.25} />
                    </div>
                    <div className="rounded-3xl rounded-tr-none border border-glass-edge bg-primary p-6 leading-relaxed text-on-primary shadow-xl shadow-primary/10 backdrop-blur-2xl">
                  ...
                  >
                    ...
                    <div className="rounded-3xl rounded-tl-none border border-glass-edge bg-surface-container-lowest/40 p-6 leading-relaxed text-on-surface shadow-sm backdrop-blur-2xl">
        ...
        <div className="relative z-10 mx-auto w-full max-w-4xl shrink-0 space-y-6 px-12 pb-24 lg:pb-8">
              ...
              >
                {SUGGESTED_PROMPTS.map((prompt) => (
                  <button
                    ...
                    className="rounded-full border border-glass-edge bg-surface-container-lowest/20 px-5 py-2.5 text-xs font-semibold text-on-surface-variant backdrop-blur-2xl transition-colors duration-150 hover:bg-surface-container-lowest/40 disabled:opacity-40"
                  >
                    {prompt}
                  </button>
                ))}
          ...
          <div className="group relative">
            ...
            <div className="relative flex items-end gap-2 rounded-full border border-glass-edge bg-surface-container-lowest/30 p-2 pl-8 shadow-2xl backdrop-blur-2xl">
              <textarea
                ref={textareaRef}
                rows={1}
                value={input}
