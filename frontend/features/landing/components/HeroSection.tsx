  ...
  return (
    <section className="mx-auto max-w-7xl px-6 pt-36 text-center sm:px-8 sm:pt-40">
      ...
      >
        ...
        <span className="text-[10px] font-medium uppercase tracking-[0.2em] text-primary-container">
      ...
      >
        Diseña el futuro
        <br />
        <span className="bg-gradient-to-r from-primary-container to-[#ffc1d1] bg-clip-text text-transparent">
          de tu contenido.
        </span>
      </motion.h1>
      ...
      >
        <Link
          href="/signup"
          className="w-full rounded-full bg-gradient-to-r from-primary to-primary-container px-10 py-4 text-lg font-semibold text-white shadow-xl shadow-primary/30 transition-all duration-300 hover:scale-105 active:scale-95 sm:w-auto sm:py-5"
        >
          Comienza gratis
        </Link>
      ...
      >
        {/* Glow */}
        <div className="absolute -inset-4 rounded-[3rem] bg-gradient-to-r from-primary/20 via-secondary/20 to-[#005da6]/20 opacity-50 blur-2xl" />
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md sm:rounded-3xl">
          ...
          {/* Content */}
          <div className="grid min-h-[300px] grid-cols-1 sm:min-h-[420px] sm:grid-cols-12 md:min-h-[500px]">
            {/* Sidebar */}
            <div className="col-span-1 flex flex-col gap-8 border-r border-white/10 bg-white/5 p-4 sm:col-span-3 sm:p-6">
              <div className="space-y-4">
                <div className="h-2 w-16 rounded-full bg-primary-container/30 sm:w-24" />
            ...
            {/* Chat area */}
            <div className="col-span-1 flex flex-col p-4 sm:col-span-9 sm:p-6 md:p-8">
              <div className="max-w-2xl space-y-5 sm:space-y-6">
                {/* Bot message */}
                <div className="flex gap-3 sm:gap-4">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-primary-container/20 bg-white/10 sm:h-10 sm:w-10">
                    <svg className="text-primary-container" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="flex flex-row-reverse gap-3 sm:gap-4">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-primary/30 bg-primary/20 sm:h-10 sm:w-10">
                    <svg className="text-primary-container" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                      <circle cx="12" cy="7" r="4" />
                    </svg>
                  </div>
                  <div className="space-y-3 rounded-2xl rounded-tr-none border border-primary/20 bg-primary/10 p-4 sm:p-5">
                    <div className="h-2 w-36 rounded-full bg-primary-container/25 sm:w-56" />
                    <div className="h-2 w-16 rounded-full bg-primary-container/15 sm:w-24" />
                  </div>
                </div>
              </div>
              ...
              <div className="mt-auto pt-4">
                <div className="flex items-center gap-3 rounded-full border border-white/20 bg-white/10 p-3 backdrop-blur-md sm:gap-4 sm:p-4">
                  ...
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-primary to-primary-container sm:h-10 sm:w-10">
