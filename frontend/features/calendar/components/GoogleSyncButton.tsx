...
export default function GoogleSyncButton() {
  return (
    <button
      disabled
      title="Próximamente"
      className="group flex w-full items-center justify-center gap-4 rounded-3xl border border-white/20 bg-surface-container-lowest/10 py-5 shadow-xl backdrop-blur-xl transition-all hover:scale-[1.03] hover:bg-surface-container-lowest/15 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:scale-100 disabled:hover:bg-surface-container-lowest/10 disabled:active:scale-100"
    >
      {/* Icono Google Calendar */}
      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-surface-container-lowest/90 p-1.5 shadow-sm transition-transform group-hover:rotate-12">
